...
get.pheno.effects <- function(data.obj, geno, marker1.name, 
	...
	result <- c("m1.name" = paste(m1.name, m1.allele, sep = "_"), 
		"m2.name" = paste(m2.name, m2.allele, sep = "_"), 
		"m1.effect" = m1.coef, "m2.effect" = m2.coef, "double.effect" = double.coef) 
	return(result)
	}