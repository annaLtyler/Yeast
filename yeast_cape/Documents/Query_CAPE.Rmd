...
```{r load_existing_results, eval = FALSE}
data_obj <- readRDS(file.path(results.dir, "cross.RDS"))
...
plot_variant_effects_query(final_obj, geno_obj, query_genotype = gal.null, 
