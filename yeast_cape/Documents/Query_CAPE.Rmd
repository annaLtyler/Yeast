...
exp.name <- "FLZ_resistance_modifier"; roi = c("chr15" = "chr15_234651"); query.alleles = 3
...
if(!file.exists(plotly.fig.file)){
  ...
  plotly_figs <- plotly_variant_effects_query(final_obj, geno_obj, 
    pheno_type = "norm_pheno", p_or_q = 1e-6, scale_coord = 1e3,
    gene.bp.window = 5000, gene.table = gene.table)

  saveRDS(plotly_figs, plotly.fig.file)
}
```
