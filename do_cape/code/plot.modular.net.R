...
micro.layout = layout_in_circle, macro.layout = layout_in_circle, 
...
vertex.label.cex = 1, edge.arrow.size = 1, edge.alpha = 0.5, 
edge.width = 1, highlight.nodes = NULL, legend.horiz = FALSE){
	...
	par(mar = c(0, 2, 2, 2))
	layout(matrix(c(1,2,3), nrow = 1, byrow = TRUE), widths = c(1,0.2, 0.2))
	# layout.show(3)
